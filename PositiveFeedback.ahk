...
:*:@@f::
{
    ...
    if (sentenceIndex = 1)
        ...
        selectedSentence := "Your submission is in{!} " selectedEmoji " " selectedAdjective "{!}"
    else if (sentenceIndex = 60)
        selectedSentence := selectedAdjective "{!} " selectedEmoji " Your submission is in{!}"
    else if (sentenceIndex = 61)
        selectedSentence := selectedEmoji " " selectedAdjective "{!} Your submission is in{!}"
    else if (sentenceIndex = 62)
        selectedSentence := "Your submission is in{!} " selectedAdjective "{!} " selectedEmoji
